      ...
      <div className="container ">
        <div className="grid grid-cols-2 items-center gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          ...
          <div className="max-md:order-1 lg:-mt-15">
            ...
            <h2 className="mb-8 max-lg:mb-4">Forge Ahead in B2B Industry with our Reverse Pipeline Strategy for Unstoppable Growth</h2>
            <p className="mb-11 max-lg:mb-6">
            We have experienced professionals who have worked with leading firms from across the globe.
            <br />
            <br />
            We have a holistic approach to all our projects. We have a new and distinct process for every task.
            <br />
            <br />
            We have a dedicated project manager for every project to blueprint and manage the entire project.
            </p>
            <ul className="mb-14 flex max-lg:mb-6 max-md:flex-col max-md:gap-y-5 lg:items-center lg:[&>*:not(:last-child)]:mr-10">
              <li className="relative flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium dark:text-white">Experienced Professionals</span>
              </li>
              <li className="relative flex items-center gap-x-2 ">
                <FontAwesomeIcon icon={faCheck} className="text-paragraph dark:text-primary" />
                <span className="font-jakarta_sans font-medium dark:text-white">Highly Process Oriented</span>
              </li>
              <li className="relative flex items-center gap-x-2 ">
                <FontAwesomeIcon icon={faCheck} className="text-paragraph dark:text-primary" />
                <span className="font-jakarta_sans font-medium dark:text-white">Dedicated Account Manager</span>
              </li>
            </ul>
