        ...
        <div className="grid grid-cols-2 items-center gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          ...
          <div className="max-md:order-1 lg:-mt-15">
            ...
            <h2 className="mb-8 max-lg:mb-4">
              Forge Ahead in B2B Industry with our Reverse Pipeline Strategy for
              Unstoppable Growth
            </h2>
            <p className="mb-11 max-lg:mb-6">
              We have experienced professionals who have worked with leading
              firms from across the globe.
              <br />
              <br />
              We have a holistic approach to all our projects. We have a new and
              distinct process for every task.
              <br />
              <br />
              We have a dedicated project manager for every project to blueprint
