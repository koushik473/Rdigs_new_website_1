      ...
      >
        <nav className="container flex items-center">
          ...
          <ul className="nav-list mx-auto hidden rounded-large bg-white p-2.5 shadow-nav dark:bg-dark-200 lg:flex [&>*:not(:last-child)]:me-1">
            {filteredMenuContent.map((menuItem) => (
              ...
              >
                ...
                >
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M4.5 0C2.01472 0 0 2.01472 0 4.5V19.5C0 21.9853 2.01472 24 4.5 24H19.5C21.9853 24 24 21.9853 24 19.5V4.5C24 2.01472 21.9853 0 19.5 0H4.5ZM7.125 19.875H3.75V9.75H7.125V19.875ZM5.4375 8.0625C4.47734 8.0625 3.6875 7.27266 3.6875 6.3125C3.6875 5.35234 4.47734 4.5625 5.4375 4.5625C6.39766 4.5625 7.1875 5.35234 7.1875 6.3125C7.1875 7.27266 6.39766 8.0625 5.4375 8.0625ZM19.875 19.875H16.5V14.625C16.5 13.3917 16.1234 12.5187 15.0225 12.5187C13.8731 12.5187 13.5 13.498 13.5 14.5625V19.875H10.125V9.75H13.375V11.1875H13.4375C13.8453 10.5 14.7284 9.75 16.408 9.75C19.0417 9.75 19.875 11.4182 19.875 14.0625V19.875Z"
                  />
                </svg>
              </button>
            </li>
            ...
            <li className="max-lg:inline-block lg:hidden">
              ...
              >
                ...
                >
                  ...
                  />
                  <path
                    d="M0 7C0 6.44772 0.447715 6 1 6H21C21.5523 6 22 6.44772 22 7C22 7.55228 21.5523 8 21 8H1C0.447716 8 0 7.55228 0 7Z"
                    fill=""
                    className="fill-paragraph dark:fill-white"
                  />
                  <path
                    d="M0 13C0 12.4477 0.447715 12 1 12H21C21.5523 12 22 12.4477 22 13C22 13.5523 21.5523 14 21 14H1C0.447716 14 0 13.5523 0 13Z"
                    fill=""
                    className="fill-paragraph dark:fill-white"
                  />
                </svg>
